    ...
    <main className="min-h-screen bg-gray-100">
      <nav className="bg-red-600 text-white px-6 py-4 flex justify-between items-center shadow">
        <div className="flex items-center gap-3">
          ...
          <h1 className="font-bold text-lg">Operadores</h1>
        </div>
        <button
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-xl shadow">
          <div className="p-6 border-b flex justify-between items-center">
            <h3 className="font-bold text-gray-700">Personal registrado</h3>
            <span className="text-sm text-gray-400">{operadores.length} operadores</span>
          </div>
          {cargando ? (
